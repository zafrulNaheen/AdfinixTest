// This is a system generated file (G2). It reflects the Starcounter App Template defined in the file "ViewModels\MainCorporationEntry.json"
// Version: 2
...
using __MFrTrend__ = global::TestProjectAdFinix.MainCorporationEntry.FranchiseOfficesElementJson.Input.Trend;
...
using __MaSortHous__ = global::TestProjectAdFinix.MainCorporationEntry.Input.SortHouseCountTrigger;
using __MaSortTota__ = global::TestProjectAdFinix.MainCorporationEntry.Input.SortTotalCommissionTrigger;
using __MaSortAvgC__ = global::TestProjectAdFinix.MainCorporationEntry.Input.SortAvgCommissionTrigger;
using __MaSortPosi__ = global::TestProjectAdFinix.MainCorporationEntry.Input.SortPositiveTrendTrigger;
using s = Starcounter;
...
public partial class MainCorporationEntry : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                SortHouseCountTrigger = Add<__TLong__>("SortHouseCountTrigger$");
                SortHouseCountTrigger.DefaultValue = 0L;
                SortHouseCountTrigger.Editable = true;
                SortHouseCountTrigger.SetCustomAccessors((_p_) => { return ((__MainCorp__)_p_).__bf__SortHouseCountTrigger__; }, (_p_, _v_) => { ((__MainCorp__)_p_).__bf__SortHouseCountTrigger__ = (System.Int64)_v_; }, false);
                SortHouseCountTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.SortHouseCountTrigger() { App = (MainCorporationEntry)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((MainCorporationEntry)pup).Handle((Input.SortHouseCountTrigger)input); });
                SortTotalCommissionTrigger = Add<__TLong__>("SortTotalCommissionTrigger$");
                SortTotalCommissionTrigger.DefaultValue = 0L;
                SortTotalCommissionTrigger.Editable = true;
                SortTotalCommissionTrigger.SetCustomAccessors((_p_) => { return ((__MainCorp__)_p_).__bf__SortTotalCommissionTrigger__; }, (_p_, _v_) => { ((__MainCorp__)_p_).__bf__SortTotalCommissionTrigger__ = (System.Int64)_v_; }, false);
                SortTotalCommissionTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.SortTotalCommissionTrigger() { App = (MainCorporationEntry)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((MainCorporationEntry)pup).Handle((Input.SortTotalCommissionTrigger)input); });
                SortAvgCommissionTrigger = Add<__TLong__>("SortAvgCommissionTrigger$");
                SortAvgCommissionTrigger.DefaultValue = 0L;
                SortAvgCommissionTrigger.Editable = true;
                SortAvgCommissionTrigger.SetCustomAccessors((_p_) => { return ((__MainCorp__)_p_).__bf__SortAvgCommissionTrigger__; }, (_p_, _v_) => { ((__MainCorp__)_p_).__bf__SortAvgCommissionTrigger__ = (System.Int64)_v_; }, false);
                SortAvgCommissionTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.SortAvgCommissionTrigger() { App = (MainCorporationEntry)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((MainCorporationEntry)pup).Handle((Input.SortAvgCommissionTrigger)input); });
                SortPositiveTrendTrigger = Add<__TLong__>("SortPositiveTrendTrigger$");
                SortPositiveTrendTrigger.DefaultValue = 0L;
                SortPositiveTrendTrigger.Editable = true;
                SortPositiveTrendTrigger.SetCustomAccessors((_p_) => { return ((__MainCorp__)_p_).__bf__SortPositiveTrendTrigger__; }, (_p_, _v_) => { ((__MainCorp__)_p_).__bf__SortPositiveTrendTrigger__ = (System.Int64)_v_; }, false);
                SortPositiveTrendTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.SortPositiveTrendTrigger() { App = (MainCorporationEntry)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((MainCorporationEntry)pup).Handle((Input.SortPositiveTrendTrigger)input); });
            }
            ...
            public __TLong__ SortHouseCountTrigger;
            public __TLong__ SortTotalCommissionTrigger;
            public __TLong__ SortAvgCommissionTrigger;
            public __TLong__ SortPositiveTrendTrigger;
        }
        #line default
    }
    #line default
    ...
    #line 2 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 3 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 4 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 6 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 7 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 8 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
    ...
    #line 18 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
        ...
        #line default
    #line hidden
    private System.Int64 __bf__SortHouseCountTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 SortHouseCountTrigger {
    #line 19 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
            return Template.SortHouseCountTrigger.Getter(this); }
        #line 19 "ViewModels\MainCorporationEntry.json"
        set {
        #line hidden
            Template.SortHouseCountTrigger.Setter(this, value); } }
        #line default
    #line hidden
    private System.Int64 __bf__SortTotalCommissionTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 SortTotalCommissionTrigger {
    #line 20 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
            return Template.SortTotalCommissionTrigger.Getter(this); }
        #line 20 "ViewModels\MainCorporationEntry.json"
        set {
        #line hidden
            Template.SortTotalCommissionTrigger.Setter(this, value); } }
        #line default
    #line hidden
    private System.Int64 __bf__SortAvgCommissionTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 SortAvgCommissionTrigger {
    #line 21 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
            return Template.SortAvgCommissionTrigger.Getter(this); }
        #line 21 "ViewModels\MainCorporationEntry.json"
        set {
        #line hidden
            Template.SortAvgCommissionTrigger.Setter(this, value); } }
        #line default
    #line hidden
    private System.Int64 __bf__SortPositiveTrendTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 SortPositiveTrendTrigger {
    #line 24 "ViewModels\MainCorporationEntry.json"
        get {
        #line hidden
            return Template.SortPositiveTrendTrigger.Getter(this); }
        #line 24 "ViewModels\MainCorporationEntry.json"
        set {
        #line hidden
            Template.SortPositiveTrendTrigger.Setter(this, value); } }
        #line default
    ...
    public class FranchiseOfficesElementJson : __Json__ {
        ...
        public static class JsonByExample {
            ...
            public class Schema : __TObject__ {
                public Schema()
                    ...
                    Trend.SetCustomAccessors((_p_) => { return ((__MaFranchis__)_p_).__bf__Trend__; }, (_p_, _v_) => { ((__MaFranchis__)_p_).__bf__Trend__ = (System.Decimal)_v_; }, false);
                }
        ...
        #line 11 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
        ...
        [_GEN1_][_GEN2_("Starcounter","2.0")]
        public System.String Name {
        #line 12 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
                return Template.Name.Getter(this); }
            #line 12 "ViewModels\MainCorporationEntry.json"
        ...
        #line 13 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
        ...
        #line 14 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
        ...
        #line 15 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
        ...
        #line 17 "ViewModels\MainCorporationEntry.json"
            get {
            #line hidden
        ...
        public static class Input {
            ...
            #line hidden
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public class Trend : Input<__MaFranchis__, __TDecimal__, Decimal> {
            }
            #line default
        }
        #line default
    ...
    public static class Input {
        ...
        #line hidden
        public class SortHouseCountTrigger : Input<__MainCorp__, __TLong__, long> {
        }
        #line default
        
        #line hidden
        public class SortTotalCommissionTrigger : Input<__MainCorp__, __TLong__, long> {
        }
        #line default
        
        #line hidden
        public class SortAvgCommissionTrigger : Input<__MainCorp__, __TLong__, long> {
        }
        #line default
        
        #line hidden
        public class SortPositiveTrendTrigger : Input<__MainCorp__, __TLong__, long> {
        }
        #line default
    }
    #line default
